...
- [ ] Add an email address to the `ADMINS` settings variable in `gitcommits/gitcommits/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `gitcommits/gitcommits/settings/production.py`
...
- Create a copy of ``gitcommits/settings/local.py.example``:
  `cp gitcommits/settings/local.py.example gitcommits/settings/local.py` (remembering you should replace `gitcommits` with your project's name!).
